export const materials = [
    ...
    { id: "magic_gem_of_saber", name: "劍之魔石"},
    { id: "magic_gem_of_archer", name: "弓之魔石"},
    { id: "magic_gem_of_lancer", name: "槍之魔石"},
    { id: "magic_gem_of_rider", name: "騎之魔石"},
    { id: "magic_gem_of_caster", name: "術之魔石"},
    { id: "magic_gem_of_assassin", name: "殺之魔石"},
    { id: "magic_gem_of_berserker", name: "狂之魔石"},

    { id: "secret_gem_of_saber", name: "劍之秘石"},
    { id: "secret_gem_of_archer", name: "弓之秘石"},
    { id: "secret_gem_of_lancer", name: "槍之秘石"},
    { id: "secret_gem_of_rider", name: "騎之秘石"},
    { id: "secret_gem_of_caster", name: "術之秘石"},
    { id: "secret_gem_of_assassin", name: "殺之秘石"},
    { id: "secret_gem_of_berserker", name: "狂之秘石"},
];